...
<body>
			...
			<div class="collapse navbar-collapse" id="collapsibleNavbar">
				<ul class="navbar-nav active">
					<li class="nav-item"><a class="nav-link" style="color: white;"
						href="showPage"><i class="fas fa-tape" id="iconsize"></i>
							Movie List</a></li>
					<li class="nav-item"><a class="nav-link" style="color: white;"
						href="showfavorite"><i class="material-icons" id="iconsize">favorite</i>
							Watch List</a></li>
				</ul>
			</div>
		</div>
	...
	<div class="modal fade" id="myModal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal body -->
				<div class="modal-body">Movie added to favorites..</div>
	...
	<div class="jumbotron text-center topBack"></div>
								...
								<div class="row">
									...
									<div class="col-6">
										<div class="addFav float-right">
											<a href="favorite?id=${temp.id}"> <i
												onclick="myFunction(this)" class="fa fa-heart"
